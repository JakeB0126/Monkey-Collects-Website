...
import { hideProduct } from "@/app/admin/products/actions";
...
export default async function AdminProductsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-3 text-4xl font-bold tracking-normal text-ink">Products</h1>
      <p className="mt-4 max-w-2xl text-base leading-7 text-neutral-700">
        Manage all database products, including active, draft, hidden, and sold out items.
      </p>
            ...
            {products.map((product) => {
              ...
              return (
                <tr key={product.id}>
                  ...
                  <td className="px-4 py-4 text-neutral-700">{product.pokemonSet ?? "None"}</td>
